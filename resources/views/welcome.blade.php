<x-layout>
    <div>
        <div class="flex flex-col items-center">
            <div class="p-4 bg-gradient-to-r from-green-500 to-blue-800 rounded-full">
                <svg class="w-24 text-white animate-pulse " xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
